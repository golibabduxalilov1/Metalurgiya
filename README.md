# 🏭 Система учета станков

Веб-приложение для централизованного учета станочного парка предприятия.
...
| **Мастер** | Реестр станков (CRUD), статусы, закрепление операторов, отчеты |
...
| `CORS_ALLOWED_ORIGINS` | Разрешенные CORS origin | `http://localhost:3000` |
